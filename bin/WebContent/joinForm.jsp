	...
	<div class="container main-container">
		...
		<div class="span3 sidebar page-right-sidebar" id="guestDetail">
			...
			<div class="input-prepend">
				...
				</span> <input class="pwd" name="pwd" size="16" type="password"
					placeholder="Password">
			</div>
			<div class="input-prepend">
				<span class="add-on"> <i class="icon-lock"></i>
				</span> <input class="pwCheck" name="pwCheck" size="16" type="password"
					placeholder="PasswordCheck">
			</div>
			<div class="input-prepend">
				<span class="add-on"> <i class="icon-user"></i>
				</span> <input class="name" name="name" size="16" type="text"
					placeholder="Name">
			</div>
			<div class="input-prepend">
				<span class="add-on"> <i class="icon-user"></i>
				</span> <input class="phone" name="phone" size="16" type="text"
					placeholder="Phone">
			</div>
			<div class="input-prepend" id="guest">
				<span class="add-on"> <i class="icon-user"></i>
				</span> <input class="guestAddr" name="addr" size="16" type="text" placeholder="우편번호" value="${zipNo }" readonly="readonly">
				<input type="button" id="guestBtn" value="주소 검색"><br>
					<input class="guestAddr" name="addr" size="16" type="text" placeholder="도로명주소" value="${roadAddr }" readonly="readonly"><br>
					<input class="guestAddr" name="addr" size="16" type="text" placeholder="나머지주소">
			</div>
			<div class="input-prepend">
				<span class="add-on"> <i class="icon-user"></i>
				</span> <input class="email" name="email" size="16" type="text"
					placeholder=Email>
			</div>
			<div class="input-prepend">
				<span class="add-on"> <i class="icon-user"></i>
				</span> <input class="nickname" name="nickname" size="16" type="text"
			...
			<div class="input-prepend">
				...
				<input name="birth" size="16" type="text" placeholder="Birth">
			</div>
		...
		<div class="span3 sidebar page-right-sidebar" id="artistDetail">
			...
			<div class="input-prepend" id="artist">
				<span class="add-on"> <i class="icon-user"></i>
				</span> <input class="artistAddr" name="addr" size="16" type="text" placeholder="우편번호" value="${zipNoA }" readonly="readonly">
				<input type="button" id="artistBtn" value="주소 검색"><br>
					<input class="artistAddr" name="addr" size="16" type="text" placeholder="도로명주소" value="${roadAddrA }" readonly="readonly"><br>
			...
			<div class="input-prepend">
				...
				<input class="birth" size="16" type="text" placeholder="Birth">
			</div>
			<div class="input-prepend">
				<span class="add-on"> <i class="icon-user"></i>
