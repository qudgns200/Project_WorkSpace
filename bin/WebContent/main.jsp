        ...
        <div class="span7 navigation">
            ...
            <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                    <li><a href="main.jsp">Full Page</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="page-full-width.htm">Pages <b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="artistMyPage.html">아티스트 개인 페이지</a></li>
                </ul>
            </li>
             <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="blog-style1.htm">Board <b class="caret"></b></a>
                <ul class="dropdown-menu">
            ...
            <form action="#" id="mobile-nav" class="visible-phone">
                ...
                <select onchange="window.open(this.options[this.selectedIndex].value,'_top')">
                    ...
                    <option value="page-full-width.htm">Pages</option>
                        <option value="artistMyPage.html">- 아티스트 개인 페이지</option>
