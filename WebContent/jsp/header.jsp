			...
			<div class="navbar hidden-phone">
				...
				<ul class="nav">
					<li class="dropdown active"><a class="dropdown-toggle"
						href="#" onclick="location.href='main.do'">Home</a></li>
					<li class="dropdown"><a class="dropdown-toggle" href="#"
						onclick="location.href='artistForm.do'">Artist</a></li>
					<li class="dropdown"><a class="dropdown-toggle" href="#"
						onclick="location.href='artForm.do'">Art</a></li>
					<li class="dropdown"><a class="dropdown-toggle" href="#"
						onclick="location.href='lectureForm.do'">Lecture</a></li>
